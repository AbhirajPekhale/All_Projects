...
public class Threading {
     public static void main(String args[]) throws IOException 
	  {
	    Student obj = new Student(100, 58, "abhishek", "mumbai", 6);
	    
	    FileOutputStream fos= null;
	    ObjectOutputStream oos= null;
	    
	    try{ 
	      fos = new FileOutputStream("C:\\Users\\Jayesh\\Desktop\\program\\student.scr"); 
     ...
     Student o=null;
     try{
       FileInputStream fis = new FileInputStream("C:\\Users\\Jayesh\\Desktop\\program\\student.scr");
